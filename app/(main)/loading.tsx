...
const Loading = () => (
  <div className="flex min-h-[60vh] items-center justify-center" role="status" aria-live="polite">
    <span className="inline-flex items-center gap-2.5 rounded-full border border-[#e6e8eb] bg-white px-4 py-2.5 text-[12.5px] font-medium text-[#4b5260] shadow-[0_2px_6px_rgba(15,23,42,0.05)]">
